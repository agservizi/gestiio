...
class EsitoServizioFinanziario extends Model
{
    use Sluggable;

    protected $table = 'tab_esiti_servizi';

    public $incrementing = false;

    public const NOME_SINGOLARE = 'esito servizio finanziario';

    public const NOME_PLURALE = 'esiti servizi finanziari';
