...
class EsitoTelefonia extends Model
{
    use Sluggable;

    protected $table = 'tab_esiti_telefonia';

    public $incrementing = false;

    public const NOME_SINGOLARE = 'esito telefonia';

    public const NOME_PLURALE = 'esiti telefonia';
