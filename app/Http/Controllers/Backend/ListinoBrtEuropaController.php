...
class ListinoBrtEuropaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('Backend.ListinoBrtEuropa.index', [
            ...
            'controller' => $nomeClasse,
            'titoloPagina' => 'Elenco '.ListinoBrtEuropa::NOME_PLURALE,
            'orderBy' => null,
            'ordinamenti' => null,
            'filtro' => $filtro ?? 'tutti',
            'conFiltro' => $this->conFiltro,
            'testoNuovo' => 'Nuovo '.ListinoBrtEuropa::NOME_SINGOLARE,
            'testoCerca' => null,
    ...
    protected function applicaFiltri($request)
    {
        ...
        $queryBuilder = ListinoBrtEuropa::query()
