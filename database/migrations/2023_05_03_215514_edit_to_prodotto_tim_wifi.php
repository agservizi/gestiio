...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('prodotto_tim_wifi', function (Blueprint $table) {
            ...
            $table->string('firmatario_nome_cognome')->nullable();
            $table->string('firmatario_indirizzo_completo')->nullable();
            $table->string('firmatario_tipo_documento')->nullable();
            $table->string('firmatario_rilasciato_da')->nullable();
            $table->string('firmatario_data_emissione')->nullable();
            $table->string('firmatario_data_scadenza')->nullable();
