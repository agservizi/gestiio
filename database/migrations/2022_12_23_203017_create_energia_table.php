...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tab_esiti_contratti_energia', function (Blueprint $table) {
        ...
        Schema::create('tab_gestori_contratti_energia', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
            $table->string('nome')->index();
            $table->string('colore_hex')->nullable();
    ...
    {
        Schema::dropIfExists('tab_gestori_contratti_energia');
        Schema::dropIfExists('tab_esiti_contratti_energia');
    }
};
