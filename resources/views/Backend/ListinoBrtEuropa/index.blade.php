...
@section('content')
    <div class="card pt-4 mb-6">
        <div class="card-header">
            <h3 class="card-title fw-bold">Monocollo</h3>
        </div>
        <div class="card-body pt-0 pb-5 fs-6" id="tabella">
            @include('Backend.ListinoBrtEuropa.tabella')
        </div>
    </div>
    <div class="card pt-4">
        <div class="card-header">
            <h3 class="card-title fw-bold">Multicollo</h3>

        </div>
        <div class="card-body pt-0 pb-5 fs-6" id="">
            @include('Backend.ListinoBrtEuropa.tabella',['records' => $recordsMulti])
        </div>
    </div>
@endsection
@push('customScript')
