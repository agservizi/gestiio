    ...
    <div class="inpost-listino-edit-page">
        ...
        <div class="card inpost-listino-edit-shell">
            <div class="card-body p-8 p-lg-10">
                ...
                <form method="POST" action="{{$vecchio ? action([$controller,'update'],$record->id) : action([$controller,'store'])}}">
                    @csrf
                    @method($vecchio ? 'PATCH' : 'POST')
