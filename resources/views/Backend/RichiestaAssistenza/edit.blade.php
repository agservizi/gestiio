...
@section('content')
    ...
    @php($clienteDettaglio = $vecchio ? $record->cliente : null)
    <div class="card">
        <div class="card-body">
                    ...
                    <div class="col-xl-4">
                        <div class="card card-bordered">
                            <div class="card-header">
                                <h3 class="card-title">Dettaglio cliente</h3>
                            </div>
                            <div class="card-body pt-4">
                                @if($clienteDettaglio)
                                    <div class="mb-4">
                                        <div class="text-muted fs-7">Codice fiscale</div>
                                        <div class="fw-bold fs-6">{{$clienteDettaglio->codice_fiscale ?: '-'}}</div>
                                    </div>
                                    <div class="mb-4">
                                        <div class="text-muted fs-7">Nominativo</div>
                                        <div class="fw-bold fs-6">{{$clienteDettaglio->nominativo() ?: '-'}}</div>
                                    </div>
                                    <div class="mb-4">
