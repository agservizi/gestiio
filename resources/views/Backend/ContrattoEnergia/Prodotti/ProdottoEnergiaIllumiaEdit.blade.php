...
<div class="row">
    <div class="col-md-6">
        @include('Backend._inputs.inputSelect2KeyValue',['campo'=>'modalita_pagamento_fattura','testo'=>'Modalita pagamento fattura','required'=>true,'array'=>\App\Models\ProdottoEnergiaIllumia::MODALITA_PAGAMENTO_FATTURA,'altro'=>'data-minimum-results-for-search="Infinity"'])
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">
        @include('Backend._inputs.inputText',['campo'=>'intestatario_conto_corrente','testo'=>'Intestatario conto corrente','required'=>true,'autocomplete'=>'off'])
    </div>
    <div class="col-md-6">
        @include('Backend._inputs.inputText',['campo'=>'codice_fiscale_intestatario','testo'=>'Codice fiscale intestatario','required'=>true,'autocomplete'=>'off'])
    </div>
</div>
<div class="row">
    <div class="col-md-6">
...
<div class="row">
    <div class="col-md-6">
        @include('Backend._inputs.inputSelect2KeyValue',['campo'=>'modalita_spedizione_fattura','testo'=>'Modalita spedizione fattura','required'=>true,'array'=>\App\Models\ProdottoEnergiaIllumia::MODALITA_SPEDIZIONE_FATTURA,'altro'=>'data-minimum-results-for-search="Infinity"'])
    </div>
</div>
<div class="row">
    <div class="col-md-6">
