                ...
                <div class="dropzone gestiio-dropzone" id="kt_dropzonejs_example_1">
                    <div class="dz-message needsclick">
                        ...
                        <div>
                            ...
                            <span>Allegati collegati allo stato del contratto energia.</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(function () {
            ...
            initGestiioDropzone("#kt_dropzonejs_example_1", {
                ...
                existingFiles: @json(\App\Models\AllegatoContrattoEnergia::perBlade($uid,$record->id)),
                sendingData: {
                    uid: function () { return $('#uid').val(); },
                    contratto_energia_id: {{$record->id}}
                }
            });
