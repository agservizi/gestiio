        ...
        <div class="card-body">
            ...
            <div class="mb-6 d-flex flex-wrap justify-content-between gap-3">
                <div>
                    ...
                    <p class="text-muted mb-0">Tariffe, capacità e prenotazioni online della tua postazione deposito bagagli.</p>
                </div>
            ...
            <div class="rounded border border-dashed p-4 bg-light mb-6">
                <div class="fw-semibold mb-1">Link pubblico prenotazione</div>
            ...
            <form method="post" action="{{ action([$controller, 'updateStationSettings']) }}" class="mb-8">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-md-4">
                        <label class="form-label fw-semibold">Max borse / prenotazione</label>
                        <input type="number" min="1" name="max_bags_per_booking" value="{{ old('max_bags_per_booking', $station->max_bags_per_booking) }}" class="form-control form-control-solid" required>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-12">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="online_booking_enabled" value="1" id="online_booking_enabled"
                                {{ old('online_booking_enabled', $station->online_booking_enabled) ? 'checked' : '' }}>
                            <label class="form-check-label" for="online_booking_enabled">Prenotazioni online abilitate sul tuo link pubblico</label>
                        </div>
                    </div>
                </div>
            ...
            <div class="border-top pt-6">
                ...
                <p class="text-muted">Usa la chiave API (solo server-side) verso <code>/api/public/deposito-bagagli/*</code>. I depositi creati restano isolati nella tua postazione.</p>
                <ul class="mb-4">
