...
@section('toolbar')
    <a class="btn btn-sm btn-primary" href="{{action([$controller,'sync'],$record->id)}}">Sincronizza ritiro</a>
@endsection
@section('content')
    <div class="card"><div class="card-body">
        ...
        @include('Backend._inputs.inputTextReadonly',['campo'=>'pickup_date','testo'=>'Data ritiro'])
