...
@section('toolbar')
    <div class="d-flex align-items-center py-1">
        <a class="btn btn-sm btn-primary fw-bold" href="{{action([$controller,'create'])}}">Nuovo ritiro InPost</a>
    </div>
@endsection
@section('content')
    <div class="card pt-4">
        <div class="card-body pt-0 pb-5 fs-6">
            <div class="table-responsive">
                <table class="table table-row-bordered">
                    <thead><tr class="fw-bolder fs-6 text-gray-800"><th>Data</th><th>Ref</th><th>Pickup date</th><th>Remote ID</th><th>Stato</th><th>Agente</th><th></th></tr></thead>
                    <tbody>
