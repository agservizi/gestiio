...
@section('toolbar')
    <div class="d-flex align-items-center py-1">
        ...
        @endisset
            <a class="btn btn-sm btn-success fw-bold d-none d-md-block me-4" href="{{action([\App\Http\Controllers\Backend\EsportaController::class,'esporta'],'clienti-assistenza')}}">Esporta CSV</a>
        @isset($testoNuovo)
...
@section('content')
    <div class="card pt-4">
        <div class="card-body pt-0 pb-5 fs-6" id="tabella">
            @include('Backend.ClienteAssistenza.tabella')
        </div>
    </div>
@endsection
@push('customScript')
