    ...
    <div class="row w-xxl-1100px g-7">
        <div class="col-12">
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="text-white fw-bold mb-1">I tuoi ticket</h2>
                    <div class="text-white opacity-75">Messaggi non letti: {{ $unreadCount }}</div>
                </div>
                <div class="d-flex gap-2">
                    <a href="{{ action([\App\Http\Controllers\Frontend\TicketController::class, 'create']) }}" data-target="kt_modal" data-toggle="modal-ajax"
                       class="btn btn-sm btn-primary">Nuovo ticket</a>
