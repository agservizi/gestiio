...
return [
    ...
    */
    ...
    'inpost' => [
        ...
        'returns_collection_endpoint' => env('INPOST_RETURNS_COLLECTION_ENDPOINT', '/returns/v1/organizations/{organizationId}/returns'),
        'returns_item_endpoint_template' => env('INPOST_RETURNS_ITEM_ENDPOINT_TEMPLATE', '/returns/v1/organizations/{organizationId}/returns/{returnId}'),
        'pickups_collection_endpoint' => env('INPOST_PICKUPS_COLLECTION_ENDPOINT', '/pickups/v1/organizations/{organizationId}/one-time-pickups'),
        'pickups_item_endpoint_template' => env('INPOST_PICKUPS_ITEM_ENDPOINT_TEMPLATE', '/pickups/v1/organizations/{organizationId}/one-time-pickups/{pickupId}'),
